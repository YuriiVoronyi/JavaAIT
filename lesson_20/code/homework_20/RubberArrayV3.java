...
//    }
    ...
    public RubberArrayV3(int[] arr) { //VAR3
    ...
    public int min() { // возвращаем мин значение из массива
        ...
        for (int i = 0; i < cursor; i++) {//Ищем мин. значение в массиве с учетом курсора
    ...
    public int max() { // возвращаем максимальное значение из массива
        ...
        for (int i = 0; i < cursor; i++) {//Ищем макс. значение в массиве с учетом курсора

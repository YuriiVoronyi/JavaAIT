 ...
 */
    public static void main(String[] args) {
        // без параметров
        // () -> 100.0;  метод без параметров возвращает 100

        //  () -> Math.random() * 1000;

        // c параметрами
        // (n) -> 2.0 / n;
        // (n) -> (n % 2) == 0;  возвращает boolean, если п четное, то вернет true
        // n -> 1/n;  если параметр один, то скобки можно не ставить

        //double getValue();
        OurValue ourValue;// Это ссылка на интерфейс OurValue
        ourValue = () -> 100.0;
        //  ourValue = () -> "str";
